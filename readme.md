...
![Questions Completed](https://img.shields.io/badge/Completed-%2F600-green?style=for-the-badge)
...
```mermaid
flowchart TD
    A[Foundations] --> B[Math & Patterns]
    B --> C[Arrays & Strings]
    C --> D[Binary Search]
    D --> E[Basic Sorting]
    E --> F[Advanced Sorting]
    F --> G[Recursion]
    G --> H[Advanced Recursion]
    H --> I[OOP]
    I --> J[Linked List]
    J --> K[Stack & Queue]
    K --> L[Sliding Window & Two Pointers]
    L --> M[Binary Tree]
    M --> N[BST & AVL]
    N --> O[Heap & Priority Queue]
    O --> P[Graphs]
    P --> Q[Greedy]
    Q --> R[Backtracking]
    R --> S[Dynamic Programming]
    S --> T[Bit Manipulation]
    T --> U[DSA Sheets / Interview Prep]
```
